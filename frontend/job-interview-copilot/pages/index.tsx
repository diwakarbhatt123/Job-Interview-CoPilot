  ...
  useEffect(() => {
    fetch('/api/profile/all', {
      ...
      if (res.ok) {
        ...
        const totalProfiles: number = response["totalProfiles"];
        const profiles: never[] = response["profiles"];
  ...
  return (
    <section className="flex min-h-screen items-center justify-center bg-gray-50">
      <div role="status" className="flex items-center justify-center">
        <svg
          aria-hidden="true"
          className="h-8 w-8 animate-spin text-gray-200 fill-black"
