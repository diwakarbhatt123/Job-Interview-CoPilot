      ...
      <div
        ...
        <div
          ...
          <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
            ...
            <h2
              className='text-center leading-tight tracking-tight text-gray-500'>Get started with
            ...
            <form className='space-y-4 md:space-y-6' onSubmit={onSubmit}>
              ...
              <p className='text-sm text-center font-light text-gray-500'>Already have an
                account? <Link
                  href={'/login'}
                  className='font-medium text-center text-blue-600 hover:underline'>Sign in</Link>
              </p>
            </form>
          </div>
        </div>
